...
Revision ID: 997027f47a25
Revises: ecf757cfa6a2
Create Date: 2022-01-08 17:17:25.789903
...
revision = '997027f47a25'
down_revision = 'ecf757cfa6a2'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('first_mu', sa.TEXT(), nullable=False),
    sa.Column('second_mu', sa.TEXT(), nullable=True),
