...
# 데이터 읽고 전처리하기
song_all_info = pd.read_csv('C:/projects/mymusic/pybo/views/fin_selected_song_all_info.csv')
...
all_encoding_df = pd.read_csv('C:/projects/mymusic/pybo/views/all_song_encoder_embedding.csv')
all_encoding_df.drop('Unnamed: 0', axis=1, inplace=True)

# 모델 부르기
sbert_model = SentenceTransformer("jhgan/ko-sbert-sts")
model = torch.load('C:/projects/mymusic/pybo/views/AE_model.pt')
okt = Okt()
